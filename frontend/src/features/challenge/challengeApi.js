...
export const { useGetChallengeResultsQuery, useGetFullChallengeByIdQuery ,useCreateFullChallengeMutation,useDeleteChallengeMutation,useUpdateChallengeMutation} = challengeApi