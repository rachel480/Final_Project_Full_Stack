...
const AboutUs = () => {
    ...
    const getVisibleItems = () => {
        ...
        for (let i = 0; i < visibleCount; i++) {
            items.push(finalList[(currentIndex + i) % total])
        }
        return items
    }
            ...
            <section className="max-w-5xl w-full px-4">
                ...
                <div className="flex flex-col items-center gap-2">
                    <div className="flex items-center justify-center gap-4 w-full">
                        ...
                        <Button variant="contained" onClick={handlePrev}>{"<"}</Button>
                        ...
                        <div className="flex overflow-hidden w-full">
                            ...
                            >
                                {getVisibleItems().map((t) => (
                                    <div key={t._id} className="flex-shrink-0 w-1/3 p-2">
                                        <div className="p-6 rounded-xl shadow-lg bg-white border-l-4 border-purple-400 h-full flex flex-col justify-between">

                                            <p className="text-gray-700 italic mb-3 animate-fadeUpSlide max-h-32 overflow-y-auto leading-relaxed">
                                                "{t.recommendtion}"
                                            </p>
